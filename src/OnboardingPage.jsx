...
export default function OnboardingPage({ email, onCreated, onSignOut }) {
  ...
  const inputCls = 'w-full rounded-xl border border-border bg-white px-4 py-3 text-base text-ink placeholder:text-slate2/60 focus:outline-none focus:ring-2 focus:ring-green/30 focus:border-green transition-all';
  ...
  return (
    <div className="min-h-screen bg-mist flex flex-col">
      ...
      <div className="flex items-center justify-center gap-2 mt-6">
        <div className={`h-2 rounded-full transition-all duration-300 ${step >= 1 ? 'w-8 bg-green' : 'w-2 bg-border'}`} />
        <div className={`h-2 rounded-full transition-all duration-300 ${step >= 2 ? 'w-8 bg-green' : 'w-2 bg-border'}`} />
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          {step === 1 && (
            <form onSubmit={handleStep1} className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-green hover:bg-green-hover text-white py-3.5 text-sm font-bold active:scale-[0.98] transition-all"
              >
                Continue
            ...
            <form onSubmit={handleStep2} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <button
                  type="submit"
                  disabled={busy}
                  className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-green hover:bg-green-hover text-white py-3.5 text-sm font-bold active:scale-[0.98] transition-all disabled:opacity-60"
                >
                  {busy
